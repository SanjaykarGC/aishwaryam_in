              ...
              <table class="table table-hover border" style="min-width: 1200px;">
                ...
                <tbody>      
                    <?php 
                          ...
                          INNER JOIN user_cred as u ON b.user_id=u.id where b.booking_status='pending' ";
                    ...
                    <tr>
                        ...
                        <td> <div style="margin-bottom: 10px;"><a href="confirm_roombook.php?id=<?php echo $row['booking_id'];?>" class="btn btn-success">Confirm</a></div> &nbsp; <a href="cancel.php?id=<?php echo $row['booking_id'];?>" class="btn btn-danger">Cancel</a></td>
                    </tr>  
                    <?php $i++; } ?>      
                </tbody>
              </table>
...
<?php 
                          ...
                          while($row=mysqli_fetch_array($res)) { ?>
                            ...
                            <div class="btn btn-warning" style="text-align: right;float: right;">Total Amount: ₹ <?php echo $row['total']; ?></div>
