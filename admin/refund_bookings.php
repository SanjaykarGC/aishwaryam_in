              ...
              <table class="table table-hover border" style="min-width: 1200px;">
                ...
                <tbody>      
                    <?php 
                          ...
                          INNER JOIN user_cred as u ON b.user_id=u.id where b.booking_status='cancelled' ";
                    ...
                    <tr>
                       ...
                       <td> <span class="btn btn-danger">Refunded</span></td>
                    </tr>  
                    <?php $i++; } ?>      
                </tbody>
              </table>
...
<?php 
                          ...
                          while($row=mysqli_fetch_array($res)) { ?>
                            ...
                            <div class="btn btn-danger" style="text-align: right;float: right;">Total Amount: ₹ <?php echo $row['total']; ?></div>
